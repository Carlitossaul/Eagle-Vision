      ...
      {loading ? (
        ...
        <div className={styles.landing}>
          <div className={styles.container}>
            ...
            <p>
              🌟 Our community invites you to explore topics like communication,
              leadership, problem-solving, time management, empathy, critical
              thinking, personal growth, and more...
            </p>
            <p>
            ...
            <p>
              🚀 Your journey to a better self starts here. Join us and gain the
              perspective that will take you beyond your limits.
            </p>
            <Link to={"/home"}>
